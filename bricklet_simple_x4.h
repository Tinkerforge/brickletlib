 ...
 *
 * bricklet_simple_x4.h: Functionality for simple sensor bricklets with 4 values
 *
...
#ifndef BRICKLET_SIMPLE_X4_H
#define BRICKLET_SIMPLE_X4_H
...
typedef struct {
    ...
    SIMPLE_VALUE_TYPE min4;
	SIMPLE_VALUE_TYPE max4;
