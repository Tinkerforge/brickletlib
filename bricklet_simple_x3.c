 ...
 *
 * bricklet_simple_x3.c: Functionality for simple sensor bricklets with 3 values
 *
	...
	if(smp[id].direction == SIMPLE_DIRECTION_SET) {
			...
			case SIMPLE_TRANSFER_THRESHOLD: {
				...
				if(sst->option == 'o' ||
				   ...
				   sst->option == 'x') {
					...
					BC->threshold_max3[smp[id].unit] = sst->min2;
				} else {
				...
				logbli("set threshold: %c %d %d %d %d %d %d (%d)\n\r", sst->option,
				                                                       sst->min1,
				                                                       sst->max1,
				                                                       sst->min2,
				                                                       sst->max2,
		...
		switch(smp[id].transfer) {
			case SIMPLE_TRANSFER_VALUE: {
				...
				logbli("get value: %d %d %d\n\r", sgvr.value1, sgvr.value2, sgvr.value3);
				break;
			}
			...
			case SIMPLE_TRANSFER_THRESHOLD: {
				...
				logbli("get threshold: %c %d %d %d %d %d %d (%d)\n\r", sgtr.option,
				                                                       sgtr.min1,
				                                                       sgtr.max1,
				                                                       sgtr.min2,
				                                                       sgtr.max2,
